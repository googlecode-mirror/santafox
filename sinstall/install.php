...
echo '<p align="center">Всё проинсталированно.</p>';
echo '<p align="center">Вы можете перейти в интерфейс администратора, пройдя по ссылке <a href="'.$url_admin.'">'.$url_admin.'</a></p>';
echo '<p align="center">Для авторизации в административном интерфейсе используйте указанный вами логин и пароль</p>';
echo '<p align="center"><b>Не забудьте обязательно стереть папку sinstall с вашего сайта.</b></p>';
