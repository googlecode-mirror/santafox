    ...
    function show()
    {
        ...
        switch ($type_run)
        {
            ...
            default:
                ...
                $html = str_replace('%leftmenu%',$kernel->pub_section_leftmenu_get(), $html);




                //Теперь заполним шаблон, но надо сделать это как всегда хитро.
                ...
                //$html = str_replace('%page_template%', $array_prop['value'], $html);
