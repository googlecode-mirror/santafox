...
INSERT INTO `%PREFIX%_faq1_content` VALUES ('5','2','Чья сборка телевизора LG 32LG7000?','Хочу приобрести у вас телевизор марки LG 32LG7000 и мне интересно где был собран этот телевизор.','<p>Добрый день! Сборка этого телевизора производится в России.</p>','natali','');
INSERT INTO `%PREFIX%_faq1_content` VALUES ('6','2','Что означает товар с уценкой?','Что означает товар с уценкой? Это брак частично или совсем?','<div>Здравствуйте! ТОвар с уценкой - это абсолютно работоспособный товар, с официальной гарантией, но имеет внешние дефекты (сколы, царапины, вмятины).</div>','natali','');
