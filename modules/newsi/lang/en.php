...
$il['news_property_deliver']            = 'Автоматически отправлять в рассылку';
$il['news_property_lenta']              = 'Автоматически добавлять в ленту';
$il['news_property_rss']                = 'Автоматически добавлять в rss';
$il['news_property_news_per_page']      = 'Новостей на страницу для АИ';

$il['news_pub_show_lenta']              = 'Показать ленту';
$il['news_pub_show_lenta_template']     = 'Шаблон ленты';
$il['news_pub_show_lenta_limit']        = 'Количество сообщений';
...
$il['news_pub_show_lenta_page']         = 'Страница для просмотра новой новости';

$il['news_pub_show_archive']            = 'Показать архив';
$il['news_pub_show_archive_template']   = 'Шаблон';
$il['news_pub_show_archive_limit']      = 'Кол-во на страницу';
$il['news_pub_show_archive_type']       = 'Тип отбора';
$il['news_pub_show_archive_default']    = 'По умолчанию';
...
$il['news_show_list_action_rss_off']        = 'Не оотбражать в RSS';
...
$il['news_property_date_label']                 = 'Дата';
$il['news_property_time_label']                 = 'Время (ЧЧ:ММ:СС)';
...
$il['news_property_pages_count']    = 'Количество страниц';
$il['news_pub_pages_type']          = 'Тип отображения страниц';
$il['news_pub_pages_get_block']     = 'Блоками по N страниц';
$il['news_pub_pages_get_float']     = 'Текущая страница всегда в центре';
