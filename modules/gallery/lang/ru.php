...
$il['gallery_property_img_big_width']  = 'Ширина большой картинки'; 	 	
$il['gallery_property_img_big_height']  = 'Высота большой картинки'; 		
$il['gallery_property_img_small_width']  = 'Ширина маленькой картинки';		
$il['gallery_property_img_small_height']  = 'Высота маленькой картинки';
$il['gallery_list_delete_element_alert']    = 'Картинка будет удалёна. Продолжить?';
...
$il['gallery_pub_random_photos'] = 'Случайные фото';
$il['gallery_items_per_page'] = 'Элементов на страницу';
$il['gallery_items_to_show'] = 'Кол-во выводимых фотографий';


$il['gallery_module_label_block_menu'] = 'Основные действия';
$il['gallery_menu_photos'] = 'Фотографии';
$il['gallery_menu_add'] = 'Добавить фотографию';
...
$il['gallery_category_delete_alert'] = 'Действительно удалить категорию (фотографии из неё НЕ будут удалены)';

$il['gallery_imageform_header'] = 'Редактирования фотографии';
...
$il['gallery_import_gen_names'] = 'Названия картинок';
