...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_LOGIN_PAGE', '/admin/index.php'); //the url to the login page
	...
	define('CONFIG_LANG_DEFAULT', (CONFIG_QUERY_STRING_ENABLE && !empty($_GET['langCode']) && file_exists(DIR_LANG . secureFileName($_GET['langCode']) . '.php')?secureFileName($_GET['langCode']):'en')); //change it to be your language file base name, such en
?>